...
# get this attribute set up nice and early
if not(hasattr(buildbot,'buildmaster')) :
...
class BuildMaster(service.MultiService):
    ...
    def __init__(self, masterdir, configFile):
        ...
        assert buildbot.buildmaster is None, \
            "only one BuildMaster is allowed per process"
